...
function buildSynthesisPrompt(
  ...
  return [
    ...
    'buyerFitReason will be placed in an email sent directly TO this company, prefixed with "Omdat jullie" (NL) or "Because you" (EN).',
    'Write in the second person plural — "jullie" for NL, "you" for EN. Never use "ze", "hun", "they", or "their".',
    'The reason should complete the sentence naturally: "Omdat jullie [reason]" or "Because you [reason]".',
    'Include both what they do AND why the domain fits — in one connected sentence.',
    'Do NOT make claims about size, growth, or status ("one of the fastest growing", "leading", "top player").',
    'Example good (NL): "zonnepanelen verkopen aan particulieren, sluit dit domein direct aan op jullie aanbod."',
    'Example good (EN): "sell solar panels to homeowners, this domain is a direct match for your core offering."',
    'Example bad: "GreenPower BV is one of the fastest growing..." or "Ze verkopen..." or "Their offering..."',
